...
public class RedCharacter1 extends BufferedImage  {
	...
	public static int  y;
	boolean bool ;
	public double chx=410;	//캐릭터의 x좌표
	
	
	public RedCharacter1(JPanel j){
		super(90,90, BufferedImage.TYPE_INT_ARGB);
		this.j = j;
		InputStream is = getClass().getResourceAsStream("attackRED3.png"); //내가 불러온 이미지를 InputStream 형으로 받아온다.
	        try { 
